        ...
        if($carts && count($carts) > 0){
            ...
            foreach ($carts as $key => $cartItem)
            {
                if($cartItem->product_id == $request->id) {
                    ...
                    $cartItem->pro_dis = (isset($data['pro_dis'])) ? $data['pro_dis'] : null;
                    ...
                    $cartItem->deal_discount_start_date = (isset($data['deal_discount_start_date'])) ? $data['deal_discount_start_date'] : null;
                    $cartItem->dealt_discount_end_date = (isset($data['dealt_discount_end_date'])) ? $data['dealt_discount_end_date'] : null;
                    ...
                    $cartItem->deal_dis = (isset($data['deal_dis'])) ? $data['deal_dis'] : null;
                    $cartItem->deal_id = (isset($data['deal_id'])) ? $data['deal_id'] : null;
                    $cartItem->save();
                    $foundInCart = true;
                }
            }
    ...
    public function updateCartItem($request){
        ...
        foreach($cart as $citem){    
            ...
            Cart::where('id', $citem['id'])->update([                
                'pro_dis' => (isset($data['pro_dis'])) ? $data['pro_dis'] : null,
                ...
                'deal_discount_start_date' => (isset($data['deal_discount_start_date'])) ? $data['deal_discount_start_date'] : null,
                'dealt_discount_end_date' => (isset($data['dealt_discount_end_date'])) ? $data['dealt_discount_end_date'] : null,
                ...
                'deal_dis' => (isset($data['deal_dis'])) ? $data['deal_dis'] : null,
