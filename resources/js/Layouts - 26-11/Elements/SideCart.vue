        ...
        <div class="ec-cart-inner">
            ...
            <div class="ec-cart-bottom">
                ...
                <div class="discount-container" v-if="cartTotalDiscount + cartTotalCoupanDiscount > 0">
                    <div class="discount-flex-item discount-flex-item-side-cart">You will save 
...
export default {
    ...
    computed: {
        ...
        ...mapGetters(["cartItems", 'cartTotal', 'currency', 'cartTotalDiscount', 'cartTotalCoupanDiscount'])
    },
    methods: {
