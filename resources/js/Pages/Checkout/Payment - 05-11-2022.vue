                                    ...
                                    <div class="checkout-page-body" :class="[(step == 'payment')?'active':'']">
                                            <div class="row m-0">
                                                <div class="col-6 col-md-4 mb-3" v-for="pm in paymentModes" :key="'paymode'+pm.value">
                                                    <label class="aiz-megabox border d-block paysec" :class="[(payment_option == pm.value)?'selected_pay':'']" @click="selectPaymentMode(pm)">
                                    ...
                                    <div class="ec-cart-summary-bottom">
                                        ...
                                        <div class="ec-cart-summary">
                                            ...
                                            <div class="ec-cart-summary-total">
                                                ...
                                                <span class="text-right">
                                                    <price :price="grandTotal-paidRewardPoint" :currency="currencyIcon"></price>
                                                </span>
                                            </div>
                                        </div>
                        ...
                        <div class="modal-content">
                            <form >
                                <div class="modal-header">
                                    ...
                                    <p>Please enter an otp send at your registered mobile</p>
                                </div>
        ...
        checkOtp(){
            ...
            axios.post('/api/check-cod-otp', {orderOtp : this.orderOtp }).then((response) => {
                if(response.data.status == 'success'){
                    ...
                    this.orderOtp = ''
                    this.payment_option = 'cash_on_delivery'
                } else {
                    this.otpError = true
